...
import { Repeat2, Star, Share, MessageCircle, Bookmark, MapPin, Smile, Download, X, MoreVertical, Check, ChevronRight, Circle, ThumbsDown } from "lucide-react";
        ...
        <div className="flex items-center gap-4">
            <DropdownMenu>
                ...
                <DropdownMenuContent className="glass-card">
                    ...
                    <DropdownMenuPrimitive.Separator className="-mx-1 my-1 h-px bg-muted/20" />
                    <DropdownMenuItem onSelect={() => alert('Feedback received!')}>
                        <ThumbsDown size={16} className="mr-2" /> Not Interested
                    </DropdownMenuItem>
                     <DropdownMenuItem onSelect={() => alert('Creator recommendations updated!')}>
                        <FaUserSlash size={16} className="mr-2" /> Don't recommend creator
                    </DropdownMenuItem>
                    {currentUser?.uid === post.userId && post.type !== 'relay' && (
                     ...
                     {currentUser?.uid !== post.userId && (
                        <DropdownMenuItem onSelect={() => alert('Reported!')} className="text-red-400">
                            <FaExclamationTriangle size={16} className="mr-2" /> Report Post
                        </DropdownMenuItem>
                     )}
                </DropdownMenuContent>
            </DropdownMenu>
