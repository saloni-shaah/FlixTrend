  ...
  (
    ...
    return (
      <aside
        ...
        className={cn(
          "hidden md:flex flex-col bg-sidebar text-sidebar-foreground border-r transition-all duration-300 ease-in-out",
  ...
  return (
    <ul
      ...
      className={cn(
        ...
        state === 'expanded' ? 'px-2' : 'items-center',
        className
      )}
      {...props}
    />
    ...
    const button = (
      <Comp
        ...
        className={cn(
          ...
          state === 'collapsed' && 'justify-center w-8 h-8 p-0',
          className
        )}
        {...props}
      >
